...
fn test_union_tree_hash() {
    ...
    assert_eq!(
        UnionNoneU64::Empty.tree_hash_root::<tree_hash::Sha256Hasher>(),
    ...
    assert_eq!(
        UnionNoneU64::Value(0).tree_hash_root::<tree_hash::Sha256Hasher>(),
    ...
    let hash_value_1 = UnionNoneU64::Value(1).tree_hash_root::<tree_hash::Sha256Hasher>();
    let hash_value_42 = UnionNoneU64::Value(42).tree_hash_root::<tree_hash::Sha256Hasher>();
...
fn test_container_tree_hash() {
    ...
    assert_eq!(
        container_zeros.tree_hash_root::<tree_hash::Sha256Hasher>(),
    ...
    assert_ne!(
        container_ones.tree_hash_root::<tree_hash::Sha256Hasher>(),
        Hash256::from_slice(&HASH_CONTAINER_ZEROS),
    ...
    assert_ne!(
        c1.tree_hash_root::<tree_hash::Sha256Hasher>(),
        c2.tree_hash_root::<tree_hash::Sha256Hasher>()
    );
    assert_ne!(
        c1.tree_hash_root::<tree_hash::Sha256Hasher>(),
        c3.tree_hash_root::<tree_hash::Sha256Hasher>()
    );
    assert_ne!(
        c2.tree_hash_root::<tree_hash::Sha256Hasher>(),
        c3.tree_hash_root::<tree_hash::Sha256Hasher>()
...
fn test_nested_container_tree_hash() {
    ...
    let hash_zeros = nested_zeros.tree_hash_root::<tree_hash::Sha256Hasher>();
    let hash_ones = nested_ones.tree_hash_root::<tree_hash::Sha256Hasher>();
    ...
    assert_ne!(
        hash_zeros,
        nested_outer_changed.tree_hash_root::<tree_hash::Sha256Hasher>(),
        "Changing outer field should change hash"
    );
    ...
    assert_ne!(
        hash_zeros,
        nested_inner_changed.tree_hash_root::<tree_hash::Sha256Hasher>(),
        "Changing inner field should change hash"
    );
}
...
fn test_container_with_bytes32() {
    ...
    let hash_zeros = container_zeros.tree_hash_root::<tree_hash::Sha256Hasher>();
    let hash_ones = container_ones.tree_hash_root::<tree_hash::Sha256Hasher>();
...
fn test_multi_variant_union() {
    // Empty variant at selector 0
    assert_eq!(
        MultiUnion::Empty.tree_hash_root::<tree_hash::Sha256Hasher>(),
        Hash256::from_slice(&HASH_UNION_EMPTY),
    ...
    // U8(1) at selector 1
    assert_eq!(
        MultiUnion::U8(1).tree_hash_root::<tree_hash::Sha256Hasher>(),
    ...
    assert_eq!(
        MultiUnion::U16(1000).tree_hash_root::<tree_hash::Sha256Hasher>(),
...
fn test_union_value_42() {
    // Union[None, uint64]::Value(42) at selector 1
    assert_eq!(
        UnionNoneU64::Value(42).tree_hash_root::<tree_hash::Sha256Hasher>(),
...
fn test_container_with_hardcoded_hash() {
    ...
    assert_eq!(
        container.tree_hash_root::<tree_hash::Sha256Hasher>(),
...
fn test_union_max_u64() {
    // Union[None, u64]::Value(MAX) at selector 1
    assert_eq!(
        UnionNoneU64::Value(u64::MAX).tree_hash_root::<tree_hash::Sha256Hasher>(),
...
fn test_union_with_container_variant() {
    ...
    assert_eq!(
        UnionEmptyData::Empty.tree_hash_root::<tree_hash::Sha256Hasher>(),
        Hash256::from_slice(&HASH_UNION_EMPTY),
        "UnionEmptyData::Empty should equal HASH_UNION_EMPTY"
    );

    assert_eq!(
        UnionEmptyData::Data(DataVariant { value: 42 }).tree_hash_root::<tree_hash::Sha256Hasher>(),
...
fn test_container_with_union_field() {
    ...
    assert_eq!(
        c_empty.tree_hash_root::<tree_hash::Sha256Hasher>(),
        Hash256::from_slice(&HASH_UNION_EMPTY),
    ...
    assert_eq!(
        c_value.tree_hash_root::<tree_hash::Sha256Hasher>(),
...
fn test_multi_union_u64_at_selector_3() {
    ...
    assert_eq!(
        MultiUnion::U64(1000000).tree_hash_root::<tree_hash::Sha256Hasher>(),
...
fn test_data_variant_container_identity() {
    ...
    assert_eq!(
        dv.tree_hash_root::<tree_hash::Sha256Hasher>(),
