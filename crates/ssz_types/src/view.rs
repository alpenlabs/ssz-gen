...
mod tests {
    ...
    fn tree_hash_variable_list_ref() {
        ...
        let owned_hash: tree_hash::Hash256 = <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&list);
        let view_hash: tree_hash::Hash256 = <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view);
    ...
    fn tree_hash_variable_list_ref_u8_empty_respects_capacity_limit() {
        ...
        let owned_hash: Hash256 = <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&owned);
        let view_hash: Hash256 = <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view);
    ...
    fn tree_hash_fixed_vector_ref() {
        ...
        let owned_hash: tree_hash::Hash256 = <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&vec);
        let view_hash: tree_hash::Hash256 = <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view);
    ...
    fn property_variable_list_tree_hash_equivalence() {
        ...
        for size in [0, 1, 5, 10, 20] {
            ...
            let owned_hash: tree_hash::Hash256 =
                <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&list);
            let view_hash: tree_hash::Hash256 =
                <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view);
    ...
    fn property_fixed_vector_tree_hash_equivalence() {
        ...
        for seed in 0..10 {
            ...
            let owned_hash: tree_hash::Hash256 =
                <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&vec);
            let view_hash: tree_hash::Hash256 =
                <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view);
    ...
    fn property_variable_list_multiple_types() {
        ...
        assert_eq!(
            <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&list_u8),
            <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view_u8)
        );
        ...
        assert_eq!(
            <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&list_u16),
            <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view_u16)
        );
        ...
        assert_eq!(
            <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&list_u32),
            <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view_u32)
        );
        ...
        assert_eq!(
            <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&list_u64),
            <_ as TreeHash>::tree_hash_root::<Sha256Hasher>(&view_u64)
        );
    }
}
